...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed = false, onToggle }) => {
  ...
  const employerNavigation: SidebarItem[] = [
    {
      name: 'Dashboard',
      href: '/dashboard',
      icon: (
  ...
  const freelancerNavigation: SidebarItem[] = [
    {
      name: 'Dashboard',
      href: '/dashboard',
      icon: (
  ...
  const settingsNavigation: SidebarItem[] = [
    {
      name: 'Settings',
      href: '/settings',
      icon: (
  ...
  const getNavigationItems = () => {
    ...
    if (session.user.role === 'EMPLOYER') {
      ...
      items = [...freelancerNavigation]
    } else if (session.user.role === 'ADMIN') {
      items = [...employerNavigation, ...freelancerNavigation, ...adminNavigation]
    }
    ...
    <div className={cn(
      ...
      {onToggle && (
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <button
            onClick={onToggle}
            className="w-full flex items-center justify-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-smooth"
          >
            <svg
